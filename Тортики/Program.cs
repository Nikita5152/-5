namespace Тортики
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            FormaTorta.AddItem(1, "Круг - 400", 400, FormaTorta.HideMenu);
            FormaTorta.AddItem(2, "Сердечко - 700", 700, FormaTorta.HideMenu);
            FormaTorta.AddItem(3, "Треугольник - 400", 400, FormaTorta.HideMenu);
            FormaTorta.AddItem(4, "Своё - 2000", 2000, FormaTorta.HideMenu);
            FormaTorta.PlayMenu = mainMenu;

            Menu SizeTorta = new Menu("->");
            SizeTorta.Zagolovok = "Размер тортика";
            SizeTorta.AddItem(0, "Маленький - 1300", 1300, SizeTorta.HideMenu);
            SizeTorta.AddItem(2, "Средний - 1800", 1800, SizeTorta.HideMenu);
            SizeTorta.AddItem(3, "Большой - 2500", 2500, SizeTorta.HideMenu);
            ...
            TasteTorta.AddItem(4, "Вишнёвый - 450", 450, TasteTorta.HideMenu);
            TasteTorta.prices = new int[] { 300, 350, 500, 400, 450 };
            ...
            InsideTorta.AddItem(4, "Лимонная - 100", 100, InsideTorta.HideMenu);
            InsideTorta.prices = new int[] {100, 250, 300, 400, 500 };
            ...
            CountYarys.AddItem(1, "Два яруса - 1000", 1000, CountYarys.HideMenu);
            CountYarys.AddItem(2, "Три яруса - 1500", 1500, CountYarys.HideMenu);
            CountYarys.PlayMenu = mainMenu;

            Menu Dekor = new Menu("->");
            Dekor.Zagolovok = "Декор";
            Dekor.AddItem(0, "Ягодный микс - 500", 500, Dekor.HideMenu);
            Dekor.AddItem(1, "Фигурка  - 300", 300, Dekor.HideMenu);
            Dekor.AddItem(2, "Сладости - 400", 400, Dekor.HideMenu);
            Dekor.AddItem(3, "Узор - 450", 450, Dekor.HideMenu);
            Dekor.AddItem(4, "Без декора", 0, Dekor.HideMenu);
            Dekor.PlayMenu = mainMenu;

            mainMenu.Zagolovok = "Тортики от Никиты";
